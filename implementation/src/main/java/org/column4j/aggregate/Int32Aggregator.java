...
public class Int32Aggregator {
    static public int indexOfAnother(Int32MutableColumn column, int value, int from, int to) {
        ...
        offset += chunkSize;
        res = Int32VectorUtils.indexOfAnother(column.getChunk((to - 1) / chunkSize).getData(), value, 0, (to - 1) % chunkSize + 1);
        if (res != -1) {
            return offset + res;
        }
        return -1;
    ...
    static public int lastIndexOfAnother(Int32MutableColumn column, int value, int from, int to) {
        ...
        offset -= chunkSize;
        res = Int32VectorUtils.lastIndexOfAnother(column.getChunk(from / chunkSize).getData(), value, from % chunkSize, column.chunkSize());
        if (res != -1) {
            return offset + res;
        }
        return -1;
    ...
    static public int indexOf(Int32MutableColumn column, int value, int from, int to) {
        ...
        offset += chunkSize;
        res = Int32VectorUtils.indexOf(column.getChunk((to - 1) / chunkSize).getData(), value, 0, (to - 1) % chunkSize + 1);
        if (res != -1) {
            return offset + res;
        }
        return -1;
    ...
    static public int lastIndexOf(Int32MutableColumn column, int value, int from, int to) {
        ...
        offset -= chunkSize;
        res = Int32VectorUtils.lastIndexOf(column.getChunk(from / chunkSize).getData(), value, from % chunkSize, column.chunkSize());
        if (res != -1) {
            return offset + res;
        }
        return -1;
