package org.column4j.mutable.impl;
...
public class StringMutableColumnImpl implements StringMutableColumn {
     ...
     * Used {@code null} as default tombstoneHolder
     */
    ...
    /**
     * Create column with passed tombstoneHolder
     *
     * @param tombstone specified tombstoneHolder
     */
    ...
    /**
     * Copy values into internal column storage with custom tombstoneHolder
     *
     * @param source source string array
     * @param tombstone column tombstoneHolder value
     */
     ...
     * @param tombstone column tombstoneHolder
     */
