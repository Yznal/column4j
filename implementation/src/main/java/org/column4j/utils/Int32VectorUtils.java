...
public final class Int32VectorUtils {
     ...
     */
    public static int[] sum(int[] data1, int[] data2, int offset1, int offset2, int elements) {
        int[] finalResult = new int[elements];
        ...
        for (; i + SPECIES_LENGTH < elements; i += SPECIES_LENGTH) {
            ...
            var v1 = IntVector.fromArray(SPECIES_PREFERRED, data1, offset1 + i, mask1);
            var v2 = IntVector.fromArray(SPECIES_PREFERRED, data2, offset2 + i, mask2);
     ...
     */
    public static int[] mul(int[] data1, int[] data2, int offset1, int offset2, int elements) {
        int[] finalResult = new int[elements];
