 ...
 * @since 0.0.1
 */
public final class ShortStatisticUtils {
    ...
    /**
     * Collect statistics of short array
     *
     * @param data      source short array
     ...
     * @return short array statistics
     */
    public static ShortStatistic collectStatistic(short[] data, int dataSize, short tombstone, int from, int to) {
        ...
        return ShortStatistic.builder(tombstone)
