...
public class Int32SkipIndex extends SkipChunkIndex implements MutableInt32ChunkIndex {
    ...
    public Int32SkipIndex(int[] data, int segmentSize) {
        super(segmentSize);
        this.dataRef = data;
    ...
    public Int32SkipIndex(int[] data) {
