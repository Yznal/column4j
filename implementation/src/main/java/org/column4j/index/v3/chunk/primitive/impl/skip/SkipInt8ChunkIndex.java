...
public class SkipInt8ChunkIndex extends SkipChunkIndex implements MutableInt8ChunkIndex {
    ...
    public SkipInt8ChunkIndex(byte[] data, int segmentSize) {
        super(segmentSize);
        this.dataRef = data;
    ...
    public SkipInt8ChunkIndex(byte[] data) {
