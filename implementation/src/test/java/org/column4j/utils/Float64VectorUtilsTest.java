...
class Float64VectorUtilsTest {
    ...
    void indexOfTest() {
        ...
        assertEquals(-1, Float64VectorUtils.indexOf(array, 1, 0, array.length));
        assertEquals(-1, Float64VectorUtils.lastIndexOf(array, 1, 0, array.length));
        assertEquals(0, Float64VectorUtils.indexOf(array, 2, 0, array.length));
        assertEquals(arraySize - 1, Float64VectorUtils.lastIndexOf(array, 2, 0, array.length));
        ...
        assertEquals(index1, Float64VectorUtils.indexOf(array, 10, 0, array.length));
        assertEquals(index2, Float64VectorUtils.lastIndexOf(array, 10, 0, array.length));
    }
