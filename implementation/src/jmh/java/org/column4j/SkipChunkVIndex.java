...
import org.column4j.index.v3.chunk.primitive.impl.skip.SkipInt32ChunkVIndex;
...
public class SkipChunkVIndex {
    ...
    SkipInt32ChunkVIndex skipIndex;
    ...
    public void setUp() {
        ...
        skipIndex = new SkipInt32ChunkVIndex(array, segmentSize);
